...
class TrafficLightVisualizerNode(LifecycleNode):
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._sub_img = Subscriber(self, Image, self.image_topic, qos_profile=self.image_qos)
    ...
    def sync_cb(self, img_msg: Image, dets_msg: DetectionArray):
        cv_img = self._bridge.imgmsg_to_cv2(img_msg)
        if cv_img.ndim == 2:
