...
class FiretruckVisualizerNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        # filtering
        self.declare_parameter("allowed_names", ["fire truck", "fire_truck", "firetruck", "truck"])
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        if self.output_enc not in ("rgb8", "bgr8", "rgba8", "bgra8"):
            self.get_logger().warn(f"[firetruck_visualizer] Invalid output_encoding '{self.output_enc}', falling back to 'rgb8'")
        ...
        self.image_qos_profile = QoSProfile(
            ...
            depth=1  # keep small for low latency
        )
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.get_logger().info(f"[firetruck_visualizer] Output image will be published as {self.output_enc}")
    ...
    def on_cleanup(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.destroy_publisher(self._bb_pub)
        self.destroy_publisher(self._kp_pub)
